...
function getArray(){
        var args = {"_xsrf": getCookie("_xsrf"), "tournament": tournament};
...
function checkSolution(){
	...
	{
        var args = {"_xsrf": getCookie("_xsrf"), "tournament": tournament, "solution": cellArray.toString()};
...
//var randomFunction = getRandomizer( 0, 2 );
//randomIndex=randomFunction();
function getRandom()
{
	randomIndex=randomFunction();
	drawCanvas();
